...
$base_url= ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST']; //url base of site if you want only relative url leave empty
$upload_dir = '/public/image_upload/images/'; // path from base_url to upload base dir
$current_path = '../../image_upload/images/'; // relative path from filemanager folder to upload files folder
